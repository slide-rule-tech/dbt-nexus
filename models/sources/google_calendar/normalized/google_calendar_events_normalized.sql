{{ config(
    ...
    materialized='table',
    tags=['normalized-layer']
) }}

-- Normalized layer: Clean, standardized representation of Google Calendar events
-- This layer transforms raw data into clean, business-ready tables
